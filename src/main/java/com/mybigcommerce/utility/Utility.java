package com.mybigcommerce.utility;

import com.google.common.base.Function;
import com.mybigcommerce.drivermanager.ManageDriver;
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/mybigcommerce/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/mybigcommerce/screenshots/" + screenshotName + dateName + ".png";
    ...
    public static void pageScrollDown() throws InterruptedException {
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("window.scrollBy(0,1500);");
        Thread.sleep(1000);
    }
    public static void pageScrollUP() throws InterruptedException {
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("window.scrollBy(0,-1500);");
        Thread.sleep(1000);
    }
